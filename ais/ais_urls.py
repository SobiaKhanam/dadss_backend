...
from . import ais_views, jmis_views, cospas_views, ais_vessel
...
urlpatterns = [
    ...
    path('merchant_vessels', ais_vessel.MerchantVesselList.as_view(), name='merchant_vessel'),
    path('merchant_vessels/<int:mv_key>', ais_vessel.MerchantTripList.as_view(), name='merchant_vessel_trips'),
    path('merchant_vessels/<int:mv_key>/<int:mtd_mt_key>', ais_vessel.TripDetailsList.as_view(), name='trip_details'),
